...
public class Identifier {
     ...
     */
    public  void initializeSystem(Context ctx) throws IOException, AlizeException {
    ...
    public SimpleSpkDetSystem alizeSystem = null;
    public DatabaseHelper mDatabaseHelper = null;

    public String[] getSpeakerList() throws AlizeException {
     ...
     */
    public void addSpeaker(short[] voiceSample, String displayName) throws AlizeException, IdAlreadyExistsException {
        ...
        Log.i("ACT","Speaker added sucessfully");
    }
     ...
     * @throws AlizeException Exception thrown when a problem inside of the alize system occurs
     */
    public void loadSpeakers() throws IOException, AlizeException {
    ...
    //    Log.i("ACT","Loaded the loadSpeakers method");
    }
     ...
     * @throws AlizeException Exception thrown when a problem inside of the alize system occurs
     */
    public void removeSpeaker(String displayName) throws AlizeException {
     ...
     * @throws AlizeException Exception thrown when a problem inside of the alize system occurs
     */
    public SpkRecResult identifySpeaker(short[] voiceSample) throws AlizeException {
